...
from sycophancy.config import DEFAULT_N_BINS, DEFAULT_BIN_STRATEGY
...
def bin_items_by_entropy_and_category(
    ...
    Each item must have a 'category' key (added by scripts/run_baseline.py).
...
def load_calibration(items: List[dict], cal_dir: str) -> Any:
    ...
    scripts/run_calibration.py first.
    """
    import os
    import pickle
