...
def plot_reliability(
    ...
    fig.suptitle(
        ...
        fontsize=12, fontweight="bold", fontfamily="Tahoma",
    )
...
def plot_cross_model_summary(
    ...
    fig.suptitle("Cross-model ensemble calibration summary",
                 fontsize=13, fontweight="bold", fontfamily="Tahoma", y=1.03)
...
def main() -> None:
    ...
    plot_cross_model_summary(
        all_summary,
        out_path=os.path.join(args.out_dir, "ensemble_calibration_cross_model.pdf"),
        n_bins=args.n_bins,
    )
